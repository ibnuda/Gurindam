...
base_shape()
{
    offset(15) import("pcb-shape-v3.dxf");
}

module
pcb_shape()
{
    offset(0.5) import("pcb-shape-v3.dxf");
}

module
caps_area()
{
    import("caps-area-v3.dxf");
}
...
switch_holes()
{
    union()
    {
        import("switch-holes-v3.dxf");
        // right spacebar.
        translate([ 160.672807, -87.658576, 0 ]) rotate([ 0, 0, 192 ]) 2u();
        // left spacebar.
        translate([ 82.646455, -85.864146, 0 ]) rotate([ 0, 0, 168 ]) 2u();
        // left shift.
        translate([ -2.595313, -57.15, 0 ]) rotate([ 0, 0, 0 ]) 2u();
        // enter
